      ...
      <FavoritesContextProvider>
        <NavigationContainer>
          <Stack.Navigator initialRouteName='Register'>
            ...
            <Stack.Screen name='DriverOverView' component={DriverOverView} options={{
              presentation: 'modal',
              headerStyle: {
            ...
            <Stack.Screen name='Home' component={DrawerNavigator} options={{
              headerRight: () => <Text>this is header</Text>
            }}/>
            <Stack.Screen name="CategoryScreen" component={CategoryScreen} options={{
              contentStyle: { backgroundColor: '#BA324F' }
            }}/>
            <Stack.Screen name='DriverOverView2' component={DriverOverView2} options={{
              headerStyle: {
                backgroundColor: "orangered"
              }
            }}/>
            <Stack.Screen name='DriverDetails' component={DriverDetails} options={{
              headerStyle: {
